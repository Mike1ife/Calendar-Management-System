...
/**
 * A mock implementation of the CalendarManagerInterface used for testing purposes.
 * This class logs every method call along with its parameters into a StringBuilder.
 */
public class MockCalendarManager implements CalendarManagerInterface {
  private final StringBuilder log;

  /**
   * Constructs a MockCalendarManager that logs method calls for testing purposes.
   *
   * @param log the StringBuilder instance to which method call logs will be appended
   */
  ...
  public void addCalendar(String name, String timeZone)
    ...
    log.append("addCalendar: ").append(name).append(" ").append(timeZone).append("\n");
  }
